...
class Radar(object):
    ...
    def render(self):
        ...
        #print "x=%f, y=%f, z=%f, anglex=%f, angley=%f, anglez=%f" % (read_game.my_pos.x, read_game.my_pos.y, read_game.my_pos.z, read_game.view_angles.x, read_game.view_angles.y, read_game.view_angles.z)
