...
class Status(object):
    ...
    def render(self):
        ...
        draw_line(frame.line, 0, read_game.resolution_y - 10, 800, 0, 20, 0xAF000000)
        ...
        for i in range(1, 13):
            ...
            draw_string_left(frame.status_font, (i-1)*65 + 5, read_game.resolution_y-15, 65, 15, color, label)
